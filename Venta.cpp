...
void Venta::setHora(const char* h)
{
    strcpy(hora, h) ;
}
void Venta::setIdMozo(int m)
{
    idMozo = m;
}
void Venta::setIdMesa(int m)
{
    idMesa = m;
}
void Venta::setIdCliente(int c)
{
    idCliente = c;
}
void Venta::setMetodoPago(int p)
{
    metodoPago = p;
}
void Venta::setEstado(int e)
{
    estado = e;
}
